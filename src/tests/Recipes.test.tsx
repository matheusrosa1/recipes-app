...
// describe('18 - Carregue as 12 primeiras receitas de comidas ou bebidas, uma em cada card', () => {
...
// describe('19 - Implemente os botões de categoria para serem utilizados como filtro', () => {
...
//     cy.getCoverage().its('Recipes.functions.pct', { timeout: 0 }).should('be.gte', 45.00);
//     cy.getCoverage().its('Recipes.branches.pct', { timeout: 0 }).should('be.gte', 45.00);
//   });
// });

// describe('20 - Implemente o filtro das receitas por meio da API ao clicar no filtro de categoria', () => {
...
//   it('Caso as receitas sejam de bebida e a categoria seja "Shake", deve-se carregar as 12 primeiras receitas de "Shake"', () => {
//     cy.visit('http://localhost:3000/drinks', {
//       onBeforeLoad(win) {
//         win.fetch = fetchMock;
//       },
...
// describe('21 - Implemente o filtro como um toggle, o qual se for selecionado novamente, o app deve retornar as receitas sem nenhum filtro', () => {
...
// describe('22 - Redirecione a pessoa usuária ao clicar no card para a tela de detalhes, que deve mudar a rota e conter o id da receita na URL', () => {
...
//     cy.getCoverage().its('Recipes.functions.pct', { timeout: 0 }).should('be.gte', 90.00);
//     cy.getCoverage().its('Recipes.branches.pct', { timeout: 0 }).should('be.gte', 90.00);
//   });
// });
...
import App from '../App';
import { MOCK_RECIPES_TEST_MEALS, MOCK_RECIPES_TEST_DRINKS } from './mocksRecipes';
